  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     ...
     <div class="my-3 p-3 bg-body rounded shadow-sm">
                <!-- FORM PENCARIAN -->
                <div class="pb-3">
                  <form class="d-flex" action="{{url('DataTunggal')}}" method="get">
                ...
                <!-- TOMBOL TAMBAH DATA -->
                <div class="pb-3">
                  <a href='{{url('DataTunggal/create')}}' class="btn btn-primary">+ Tambah Data</a>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->data}}</td>
                            <td>
                                <a href='{{url('DataTunggal/'.$item->data.'/edit')}}' class="btn btn-warning btn-sm">Edit</a>
                                <form onsubmit="return confirm('yakin akan menghapus data?')"class="d-inline"action="{{url('DataTunggal/'.$item->data)}}" method="post">
                                    @csrf
                                    @method('DELETE')
...
<!-- <script src="ProjectStatistikBakti/dist/js/demo.js"></script> -->
